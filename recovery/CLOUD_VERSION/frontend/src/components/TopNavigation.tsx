...
const AvatarPlaceholderIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    <header className="sticky top-0 z-30 border-b border-[#e0f1fb] bg-[#f8fcff]/80 backdrop-blur">
      <div className="flex h-[56px] items-center justify-end gap-4 px-6">
        ...
        <div className="relative" ref={menuRef}>
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full border border-[#06c3a8]/50 bg-white text-xs font-semibold text-[#06c3a8] shadow transition hover:bg-[#06c3a8]/10"
        >
          <AvatarPlaceholderIcon className="h-4 w-4" />
        </button>
          {menuOpen && (
            <div className="absolute right-0 mt-2 w-44 rounded-xl border border-slate-100 bg-white py-2 text-sm text-slate-700 shadow-lg">
              <button className="flex w-full items-center px-4 py-2 text-left hover:bg-[#eef6fd]">
                账号信息
              </button>
              <button className="flex w-full items-center px-4 py-2 text-left hover:bg-[#eef6fd]">
                开通会员 / 我的会员
              ...
              <button className="flex w-full items-center px-4 py-2 text-left text-red-500 hover:bg-red-50">
                退出登录
              </button>
            </div>
          )}
